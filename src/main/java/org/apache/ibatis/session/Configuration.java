...
public class Configuration {
  ...
  /**
   * 很重要  里面存储mapper接口和实际实现功能的mapper接口的代理类
   */
  ...
  /**
   * 解析之后的sql的insert update delete select标签的内容就在这里存储
   *
   * String默认是以namespace+id的值
   * MappedStatement就是内容
   */
  ...
  /**
   * 存储解析过的mapper的文件名  interface 接口全路径   namespace:接口的全路径
   */
